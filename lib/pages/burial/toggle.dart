...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text('GridView and ListView Toggle'),
        ),
        body: GridViewListViewToggle(),
      );
...
class GridViewListViewToggle extends StatefulWidget {
  @override
  _GridViewListViewToggleState createState() => _GridViewListViewToggleState();
}
...
// Define BurialCard and BurialCard2 classes here
