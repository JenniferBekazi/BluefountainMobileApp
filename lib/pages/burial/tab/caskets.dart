...
class CasketsTab extends StatefulWidget{
  const CasketsTab({Key ? key}): super(key : key);

  State<CasketsTab> createState() => _CasketsTabState();
}

class _CasketsTabState extends State<CasketsTab>  {
  bool isGrid = true;
