...
class HearsesTab extends StatefulWidget{
  const HearsesTab({Key ? key}): super(key : key);

  State<HearsesTab> createState() => _HearsesTabState();
}

class _HearsesTabState extends State<HearsesTab>  {
  bool isGrid = true;
