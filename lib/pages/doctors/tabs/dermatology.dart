...
class DermatologyTab extends StatefulWidget{
  @override
  State<DermatologyTab> createState() => _DermatologyTabState();
}

class _DermatologyTabState extends State<DermatologyTab> {
  bool isGrid = true;
