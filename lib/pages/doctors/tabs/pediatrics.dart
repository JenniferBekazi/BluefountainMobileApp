...
class PediatricsTab extends StatefulWidget{
  final List<DoctorsModel> doctors;
  final List<BookingsModel> bookings;
  PediatricsTab({required this.doctors, required this.bookings});
  @override
  State<PediatricsTab> createState() => _PediatricsTabState();
}

class _PediatricsTabState extends State<PediatricsTab> {
  bool isGrid = true;
            ...
            children: [
              Expanded(
                flex: 4,
                  ...
                  child: Column( children:widget.doctors.map(
                        (doctor) => DoctorCard2(
              ...
              //         (doctor) => DoctorCard2(
              //           imagePath: 'icons/doctor3.jpg',
              //           doctorName: doctor.personalDetails.lastName,
