...
class BeardHaircutTab extends StatefulWidget{
  const BeardHaircutTab({Key ? key}): super(key : key);

  State<BeardHaircutTab> createState() => _BeardHaircutTabState();
}

class _BeardHaircutTabState extends State<BeardHaircutTab>  {
  bool isGrid = true;
