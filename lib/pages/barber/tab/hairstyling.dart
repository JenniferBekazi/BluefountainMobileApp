...
class HairstylingTab extends StatefulWidget{
  const HairstylingTab({Key ? key}): super(key : key);

  State<HairstylingTab> createState() => _HairstylingTabState();
}

class _HairstylingTabState extends State<HairstylingTab>  {
  bool isGrid = true;
