...
class RazorShaveTab extends StatefulWidget{
  const RazorShaveTab({Key ? key}): super(key : key);

  State<RazorShaveTab> createState() => _RazorShaveTabState();
}

class _RazorShaveTabState extends State<RazorShaveTab>  {
  bool isGrid = true;
