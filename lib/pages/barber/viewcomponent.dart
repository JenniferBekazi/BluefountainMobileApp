...
import '../appointments/components/reschedule.dart';
import '../components/bottomnavigationbar.dart';
import '../components/listitemsclass.dart';
...
class ViewComponent1 extends StatefulWidget{

  final String? name;
  final String? date;
  final String? time;
  final String? surname;
  late final String? hairstyle;
  final String? procedure;
  ...
  final BarbersModel barbersModel;
  ViewComponent1({ required this.barbersModel,
    Key ? key,
    required this.name,
  ...
  State<ViewComponent1> createState() => _ViewComponent1State();

}



class _ViewComponent1State extends State<ViewComponent1> with SingleTickerProviderStateMixin{
  ...
  Future<int?> rescheduleappointments(date, time, hairstyle, procedure, name,
      id) async{
    ...
    try {
      ...
      final prevAppointmentSchedule = {
        ...
        "department": widget.name,
        "procedure": widget.procedure,
        "applied_service": widget.hairstyle,
        "serviceProvider": widget.dep,
      };
  ...
  //build tabs
  Widget _buildUpcoming({required List<BarbersModel> bookings,}) => Padding(
        ...
        ListTile(
          ...
          subtitle: Column(
            ...
            children: [
              ...
              Text(
                "CustomersID : " "${widget.barbersModel?.id}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              SizedBox(height: 2,),
              Text("First Name : " "${widget.barbersModel?.name}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              ...
              Text("Last Name :" "${widget.barbersModel?.surname}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              ...
              Text("Gender: " "${widget.barbersModel?.gender}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              ...
              Text("National ID : " "${widget.barbersModel?.nationalId}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              ...
              Text("Hairstyle : " "${widget.barbersModel?.hairstyle}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              SizedBox(height: 2,),
              Text("Status : " "${widget.barbersModel?.status}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              ...
              Text("Company : " "${widget.barbersModel?.company}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              ...
              Text("Price : " "${widget.barbersModel?.price}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              ...
              Text("Appointment Time : " "${widget.barbersModel?.time}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              ...
              Text("Appointment Date : " "${widget.barbersModel?.date}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
              ...
              Text("Street Address : " "${widget.barbersModel?.streetAddress1}",
                style: TextStyle(
                  fontWeight: FontWeight.w600,
                  fontSize: 15,
                ),),
  ...
  Widget _buildUpcoming1({required List<BarbersModel> bookings,}) => Padding(
    padding: const EdgeInsets.all(25.0),
    child: ListView(
  ...
  Widget _buildUpcoming2({required List<BarbersModel> bookings,}) => Padding(
    padding: const EdgeInsets.all(25.0),
    child: ListView(
  ...
  String? departmentVariable;
  String? procedureVariable;
  String? barberNameVariable;
  String? hairstyleVariable;
  ...
  Widget _rescheduleForm({required List<BarbersModel> bookings,}) =>
      Padding(
        padding: const EdgeInsets.all(13.0),
        child: SingleChildScrollView(
          physics: ClampingScrollPhysics(),
          child: Column(
            ...
            children: <Widget>[
              Text('Branch'),
              DropDownField(
                value: barberNameVariable,
                hintText: 'Select Branch',
                dataSource: ListItems().barberIterms,
                onChanged: (value) {
                  setState(() {
                    barberNameVariable = value;
                  });
                },
                textField: 'label',
                valueField: 'value',
            ...
            builder: (context, state) {
              switch (state.runtimeType) {
                ...
                case PostFetchingSuccessfulState:
                  ...
                  final List<BarbersModel> bookingsList = successState.posts.cast<BarbersModel>();
                  ...
                  return TabBarView(
                    ...
                    children: [
                      ...
                      _buildUpcoming1(bookings: bookingsList,),
                      _buildUpcoming2(bookings: bookingsList,),
