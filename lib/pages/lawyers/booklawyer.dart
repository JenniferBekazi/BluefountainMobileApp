...
class BookLawyer extends StatefulWidget{
  const BookLawyer({Key ? key}): super(key : key);

  State<BookLawyer> createState() => _BookLawyerState();
}

class _BookLawyerState extends State<BookLawyer>{
  //api data
