...
class HaircutTab extends StatefulWidget{
  const HaircutTab({Key ? key}): super(key : key);

  State<HaircutTab> createState() => _HaircutTabState();
}

class _HaircutTabState extends State<HaircutTab>  {
